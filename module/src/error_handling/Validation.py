...
class Inputscheck(BaseModel):
    ...
    yearlist: conlist(int, min_items=1, max_items=10000)
    techlist: conlist(str, min_items=0, max_items=10000)
    maxcapinvestment: conlist(float, min_items=0, max_items=10000)
    mincapinvestment: conlist(float, min_items=0, max_items=10000)
    mincap: conlist(float, min_items=0, max_items=10000)
    annactlowlim: conlist(float, min_items=0, max_items=10000)
    annactupplim: conlist(float, min_items=0, max_items=10000)
    modperactlowlim: conlist(float, min_items=0, max_items=10000)
    modperactupplim: conlist(float, min_items=0, max_items=10000)
    rescap: conlist(float, min_items=0, max_items=10000)
    maxcap: conlist(float, min_items=0, max_items=10000)
    resstocap: conlist(float, min_items=0, max_items=10000)
    maxstocap: conlist(float, min_items=0, max_items=10000)
    stolevelstart: conlist(float, min_items=0, max_items=10000)
    stolist: conlist(str, min_items=0, max_items=10000)
    MOOLIST: conlist(str, min_items=1, max_items=2)
    STOLIST: conlist(str, min_items=0, max_items=10000)
    listcf: conlist(str, min_items=0, max_items=10000)
    listcfcheck: conlist(str, min_items=0, max_items=10000)
    cftechlist: conlist(str, min_items=0, max_items=10000) 
    setstechlist: conlist(str, min_items=0, max_items=10000)
