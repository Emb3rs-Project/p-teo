...
class Inputscheck(BaseModel):
    ...
    yearlist: conlist(int, min_items=1, max_items=1000)
    techlist: conlist(str, min_items=0, max_items=1000)
    maxcapinvestment: conlist(float, min_items=0, max_items=1000)
    mincapinvestment: conlist(float, min_items=0, max_items=1000)
    mincap: conlist(float, min_items=0, max_items=1000)
    annactlowlim: conlist(float, min_items=0, max_items=1000)
    annactupplim: conlist(float, min_items=0, max_items=1000)
    modperactlowlim: conlist(float, min_items=0, max_items=1000)
    modperactupplim: conlist(float, min_items=0, max_items=1000)
    rescap: conlist(float, min_items=0, max_items=1000)
    maxcap: conlist(float, min_items=0, max_items=1000)
    resstocap: conlist(float, min_items=0, max_items=1000)
    maxstocap: conlist(float, min_items=0, max_items=1000)
    stolevelstart: conlist(float, min_items=0, max_items=1000)
    stolist: conlist(str, min_items=0, max_items=1000)
    MOOLIST: conlist(str, min_items=1, max_items=2)
    STOLIST: conlist(str, min_items=0, max_items=1000)
    listcf: conlist(str, min_items=0, max_items=1000)
    listcfcheck: conlist(str, min_items=0, max_items=1000)
    cftechlist: conlist(str, min_items=0, max_items=1000) 
    setstechlist: conlist(str, min_items=0, max_items=1000)
    listspd: conlist(str, min_items=0, max_items=1000)
    listspdprof: conlist(str, min_items=0, max_items=1000)
    listcfcap: conlist(str, min_items=0, max_items=1000)
